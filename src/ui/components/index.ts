/** Codex design-system components (DESIGN-SPEC §4). */
export { Caps, Copt, Numeral, Tag, Folio, Rubric, Register, Fleuron, Plate } from './primitives';
export { Mark, Tally, Dots, type MarkState } from './marks';
