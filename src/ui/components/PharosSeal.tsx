...
export function PharosSeal({ size = 64, color }: { size?: number; color?: string }) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 64 64">
      ...
      {/* beacon rays */}
      <Path d="M32 22 L21 13" stroke={stroke} strokeWidth={1.2} strokeLinecap="round" opacity={0.7} />
      <Path d="M32 22 L43 13" stroke={stroke} strokeWidth={1.2} strokeLinecap="round" opacity={0.7} />
      <Path d="M32 22 L15 22" stroke={stroke} strokeWidth={1.2} strokeLinecap="round" opacity={0.7} />
      <Path d="M32 22 L49 22" stroke={stroke} strokeWidth={1.2} strokeLinecap="round" opacity={0.7} />
      {/* bulb */}
