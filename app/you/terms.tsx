/**
 * Terms of service — renders the canonical doc from src/content/legal.ts so the
...
import { TERMS, LEGAL_META } from '../../src/content/legal';
...
export default function Terms() {
  ...
  return (
    <Page>
      <SheetBar left="You" title={TERMS.title} onBack={() => router.back()} />
